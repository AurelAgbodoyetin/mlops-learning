...
if __name__ == "__main__":
    ...
    experiment_obj = mlflow.set_experiment(experiment_name="ElasticNet-Wine-Quality-AutoLogging")
    ...
    mlflow.autolog( # <- New Line Enable autologging for MLflow
        log_input_examples=True,  # <- New Line Enable input example logging
        log_model_signatures=True  # <- New Line Enable model signature logging
    )
